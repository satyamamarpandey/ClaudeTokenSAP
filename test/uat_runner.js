/**
 * Token Optimizer v2.0.0 — Comprehensive UAT Runner
...
for (const [projectKey, project] of Object.entries(PROJECTS)) {
  test(`SessionStart: ${project.desc} — stack detection + policy injection`, () => {
    ...
    if (!ctx.includes("TOKEN OPTIMIZER v2.0.0")) throw new Error("Missing version header");
...
console.log("\n" + "═".repeat(72));
console.log("  TOKEN OPTIMIZER v2.0.0 — UAT RESULTS");
